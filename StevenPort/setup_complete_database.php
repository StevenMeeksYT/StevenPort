<?php
/**
 * Complete Database Setup Script for StevenPort
...
echo "<h1 class='page-title'>Complete Database Setup for StevenPort</h1>";
...
try {
    ...
    $sqlFile = __DIR__ . '/create_database_complete.sql';
    ...
    echo "<script>addProgress('📊 Database Creation Complete');</script>";
    ...
    if ($errorCount === 0) {
        ...
        if ($testConn) {
            ...
            $tables = ['users', 'tcdatabase', 'user_sessions', 'user_activity_logs'];
...
echo "<script>addProgress('<a href=\"tc_database.php\">Go to Tropical Cyclone Database</a>');</script>";
flush();
